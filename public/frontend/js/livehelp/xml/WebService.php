...
function Login() {
	...
	if (!isset($_REQUEST['Acción'])){ $_REQUEST['Acción'] = ''; }
...
function Users() {
	...
	if ($_REQUEST['Acción'] == 'Accept' && $_REQUEST['ID'] != '0') {
	...
	elseif ($_REQUEST['Acción'] == 'Close' && $_REQUEST['ID'] != '0') {
...
END;
	...
	elseif ($_REQUEST['Acción'] == 'Transfer' && $_REQUEST['ID'] != '0' && $_REQUEST['Transfer'] != '0') {
	
		$query = "UPDATE " . $table_prefix . "chats SET `datetime` = NOW(), `active`= '-2', `transfer` = '" . $_REQUEST['Transfer'] . "' WHERE `id` = '" . $_REQUEST['ID'] . "'";
		$SQL->updatequery($query);
		
	}
	elseif ($_REQUEST['Acción'] == 'Block' && $_REQUEST['ID'] != '0') {
	...
	elseif ($_REQUEST['Acción'] == 'Unblock' && $_REQUEST['ID'] != '0') {
	...
	elseif ($_REQUEST['Acción'] == 'Hidden' || $_REQUEST['Acción'] == 'Offline') {
	...
	if ($_SETTINGS['SERVERVERSION'] >= 3.90) {
		...
		} elseif ($_REQUEST['Acción'] == 'Online' || $_REQUEST['Acción'] == 'BRB' || $_REQUEST['Acción'] == 'Away' || $_REQUEST['Acción'] == 'Hidden') {
...
function Visitors() {
	...
	if ($_REQUEST['Acción'] == 'Initiate' && $_OPERATOR['PRIVILEGE'] < 4) {
	...
	elseif ($_REQUEST['Acción'] == 'Remove' && $_OPERATOR['PRIVILEGE'] < 3) {
